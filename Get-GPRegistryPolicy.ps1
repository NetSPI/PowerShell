...
Function  Get-GPRegistryPolicy
{
    ...
    Process
    {
        ...
        Write-Verbose "DC    : $DomainController"
        Write-Verbose "Path  : $ServerPath"
        Write-Verbose "-----------------------------------"
        Write-Verbose "Execution Status"
        Write-Verbose "-----------------------------------"
        ...
        Write-Verbose "-----------------------------------"
        Write-Verbose "Export Summary"
        Write-Verbose "-----------------------------------"
        $Outfile = "Registry.pol_Entries_$domain.csv"
        $Results | Sort-Object ValueName  | Export-Csv -NoTypeInformation $Outfile
        Write-Verbose "Results written to Registry.pol_Entries_$domain.csv"
