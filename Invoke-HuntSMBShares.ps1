...
<div background-color:#f0f3f5;">
	  ...
	  <Br>
	  <span class="pagetitlesub">HUNT SMB SHARES</span>	 
	  <br>
	  <span style="font-size: 16;font-weight:bold;color:#3D3935">Excessive Share Privileges Report</span>
	  <br>
	  <span style="font-size: 14;color:#3D3935">Domain: $TargetDomain <br> Completed: $EndTime</span>
</div>	
<br>
