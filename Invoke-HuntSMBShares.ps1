...
<div style="border-bottom: 2px solid red; background-color:#f0f3f5;"> 
	  ...
	  <br>
	  <span style="font-size: 16;font-weight:bold;">$TargetDomain Excessive Privileges Report</span>
	  <br>
	  <span style="font-size: 14;font-weight:bold;color:#999">Completed: $EndTime</span>
	  </div>	
	  </div>
      <div class="topone">
	  <br>
