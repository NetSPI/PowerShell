...
<div style="border-bottom: 2px solid red; background-color:#f0f3f5;"> 
	  ...
	  <Br>
	  <span style="font-size: 20;font-weight:bold;">SMB Share Discovery Scan</span>
	  <br>
	  <span style="font-size: 16;font-weight:bold;color:#999">Excessive Privileges Report</span>
	  </div>	
