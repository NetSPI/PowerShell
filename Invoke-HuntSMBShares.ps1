...
<div background-color:#f0f3f5;">
      ...
      <div style="font-size: 14; margin-left: 0px;overflow:auto;display:block;height: 100px;overflow: hidden;">
	  <Br>
	  <span class="pagetitlesub">SMB SHARES HUNTER</span>	 
	  <br>
	  <span style="font-size: 16;font-weight:bold;color:#3D3935">SMB Share Excessive Privileges Report</span>
	  <br>
